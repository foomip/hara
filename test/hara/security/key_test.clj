(ns hara.security.key-test
  (:use hara.test)
  (:require [hara.security.key :refer :all]))

^{:refer hara.security.key/init-key-generator :added "2.4"}
(comment "initializes a `KeyGenerator` object")

^{:refer hara.security.key/generate-key :added "2.4"}
...
^{:refer hara.security.key/init-key-pair-generator :added "2.4"}
(comment "initializes a `KeyPairGenerator` object")

^{:refer hara.security.key/generate-key-pair :added "2.4"}
...
^{:refer hara.security.key/key-mode :added "2.4"}
...
^{:refer hara.security.key/key-type :added "2.4"}
(fact "returns the type of a key"

  (key-type (generate-key "AES" {:length 128}))
  => "AES")

^{:refer hara.security.key/key->map :added "2.4"}
...
^{:refer hara.security.key/to-bytes :added "2.4"}
(comment "transforms input to a byte array")

^{:refer hara.security.key/map->key :added "2.4"}
...
^{:refer hara.security.key/->key :added "2.4"}
