(ns hara.security.verify-test
  (:use hara.test)
  (:require [hara.security.verify :refer :all]
            [hara.security.key :as key]
            [hara.io.encode :as encode]
            [clojure.string :as string]))

^{:refer hara.security.verify/digest :added "2.4"}
...
^{:refer hara.security.verify/init-hmac :added "2.4"}
(comment "initializes the hmac algorithm")

^{:refer hara.security.verify/hmac :added "2.4"}
...
^{:refer hara.security.verify/sign :added "2.4"}
...
^{:refer hara.security.verify/verify :added "2.4"}
